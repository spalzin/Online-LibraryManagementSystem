...
{  $error_message="";
    ...
    {   
        $psd=mysqli_query($conn,"update registered_users set password='$_POST[password]' where rollno='$_SESSION[r]'");
...
<h3  >Enter OTP</h3>
  ...
  <label style="color: red;"><?php echo $msg ?></label>
                    ...
                    <div class="form-group">
                        <button class="btnSubmit" type="submit" name="changepass">Change Password</button>
                    </div>
